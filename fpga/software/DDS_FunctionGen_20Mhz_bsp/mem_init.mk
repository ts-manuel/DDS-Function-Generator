...
.PHONY: FLASH
FLASH: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym $(MEM_0).flash

# Memory: LOOKUP_RAM_RAM_DDS0
MEM_1 := NiosII_Processor_LOOKUP_RAM_RAM_DDS0
$(MEM_1)_NAME := LOOKUP_RAM_RAM_DDS0
...
$(MEM_1)_START := 0x0000a000
$(MEM_1)_END := 0x0000a7ff
$(MEM_1)_SPAN := 0x00000800
$(MEM_1)_HIERARCHICAL_PATH := LOOKUP_RAM.RAM_DDS0
$(MEM_1)_WIDTH := 16
$(MEM_1)_HEX_DATA_WIDTH := 16
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: LOOKUP_RAM_RAM_DDS0
LOOKUP_RAM_RAM_DDS0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: LOOKUP_RAM_RAM_DDS0_AM
MEM_2 := NiosII_Processor_LOOKUP_RAM_RAM_DDS0_AM
$(MEM_2)_NAME := LOOKUP_RAM_RAM_DDS0_AM
...
$(MEM_2)_END := 0x000097ff
$(MEM_2)_SPAN := 0x00000800
$(MEM_2)_HIERARCHICAL_PATH := LOOKUP_RAM.RAM_DDS0_AM
$(MEM_2)_WIDTH := 16
$(MEM_2)_HEX_DATA_WIDTH := 16
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: LOOKUP_RAM_RAM_DDS0_AM
LOOKUP_RAM_RAM_DDS0_AM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: LOOKUP_RAM_RAM_DDS0_FM
MEM_3 := NiosII_Processor_LOOKUP_RAM_RAM_DDS0_FM
$(MEM_3)_NAME := LOOKUP_RAM_RAM_DDS0_FM
...
$(MEM_3)_START := 0x00009800
$(MEM_3)_END := 0x00009fff
$(MEM_3)_SPAN := 0x00000800
$(MEM_3)_HIERARCHICAL_PATH := LOOKUP_RAM.RAM_DDS0_FM
$(MEM_3)_WIDTH := 16
$(MEM_3)_HEX_DATA_WIDTH := 16
$(MEM_3)_ENDIANNESS := --little-endian-mem
$(MEM_3)_CREATE_LANES := 0

.PHONY: LOOKUP_RAM_RAM_DDS0_FM
LOOKUP_RAM_RAM_DDS0_FM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym

# Memory: LOOKUP_RAM_RAM_DDS1
MEM_4 := NiosII_Processor_LOOKUP_RAM_RAM_DDS1
$(MEM_4)_NAME := LOOKUP_RAM_RAM_DDS1
...
$(MEM_4)_START := 0x0000b800
$(MEM_4)_END := 0x0000bfff
$(MEM_4)_SPAN := 0x00000800
$(MEM_4)_HIERARCHICAL_PATH := LOOKUP_RAM.RAM_DDS1
$(MEM_4)_WIDTH := 16
$(MEM_4)_HEX_DATA_WIDTH := 16
$(MEM_4)_ENDIANNESS := --little-endian-mem
$(MEM_4)_CREATE_LANES := 0

.PHONY: LOOKUP_RAM_RAM_DDS1
LOOKUP_RAM_RAM_DDS1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_4).hex $(HDL_SIM_DIR)/$(MEM_4).dat $(HDL_SIM_DIR)/$(MEM_4).sym

# Memory: LOOKUP_RAM_RAM_DDS1_AM
MEM_5 := NiosII_Processor_LOOKUP_RAM_RAM_DDS1_AM
$(MEM_5)_NAME := LOOKUP_RAM_RAM_DDS1_AM
...
$(MEM_5)_START := 0x0000a800
$(MEM_5)_END := 0x0000afff
$(MEM_5)_SPAN := 0x00000800
$(MEM_5)_HIERARCHICAL_PATH := LOOKUP_RAM.RAM_DDS1_AM
$(MEM_5)_WIDTH := 16
$(MEM_5)_HEX_DATA_WIDTH := 16
$(MEM_5)_ENDIANNESS := --little-endian-mem
$(MEM_5)_CREATE_LANES := 0

.PHONY: LOOKUP_RAM_RAM_DDS1_AM
LOOKUP_RAM_RAM_DDS1_AM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_5).hex $(HDL_SIM_DIR)/$(MEM_5).dat $(HDL_SIM_DIR)/$(MEM_5).sym

# Memory: LOOKUP_RAM_RAM_DDS1_FM
MEM_6 := NiosII_Processor_LOOKUP_RAM_RAM_DDS1_FM
$(MEM_6)_NAME := LOOKUP_RAM_RAM_DDS1_FM
...
$(MEM_6)_START := 0x0000b000
$(MEM_6)_END := 0x0000b7ff
$(MEM_6)_SPAN := 0x00000800
$(MEM_6)_HIERARCHICAL_PATH := LOOKUP_RAM.RAM_DDS1_FM
$(MEM_6)_WIDTH := 16
$(MEM_6)_HEX_DATA_WIDTH := 16
$(MEM_6)_ENDIANNESS := --little-endian-mem
$(MEM_6)_CREATE_LANES := 0

.PHONY: LOOKUP_RAM_RAM_DDS1_FM
LOOKUP_RAM_RAM_DDS1_FM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_6).hex $(HDL_SIM_DIR)/$(MEM_6).dat $(HDL_SIM_DIR)/$(MEM_6).sym

# Memory: RAM_24K
MEM_7 := NiosII_Processor_RAM_24K
$(MEM_7)_NAME := RAM_24K
...
$(MEM_7)_START := 0x00000000
$(MEM_7)_END := 0x00005dbf
$(MEM_7)_SPAN := 0x00005dc0
$(MEM_7)_HIERARCHICAL_PATH := RAM_24K
$(MEM_7)_WIDTH := 32
...
.PHONY: RAM_24K
RAM_24K: check_elf_exists $(MEM_INIT_DIR)/$(MEM_7).hex $(HDL_SIM_DIR)/$(MEM_7).dat $(HDL_SIM_DIR)/$(MEM_7).sym
